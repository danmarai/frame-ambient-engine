...
The output should preserve a premium ambient aesthetic. This means the renderer should avoid dashboard clichés, harsh borders, noisy chart geometry, and excessive text. Overlays should remain subtle. The weather bar, when enabled, should feel like a restrained informational strip rather than a ticker.
